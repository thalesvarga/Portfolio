export const dataBaseProjetos = [
  ...
  A aplicação utiliza diversas técnicas em JavaScript, HTML5 e CSS3, incluindo:<br><br>
    ...
    imagem: "/assets/AtividadeCronometrada.png",
  ...
  A aplicação foi desenvolvida utilizando técnicas avançadas em JavaScript, HTML5 e CSS3, incluindo:<br><br>
    ...
    imagem: "/assets/CondeConnect1.png",
  ...
  },
  {
    ...
    imagem: "/assets/listadecompra.png",
  ...
  },
  {
    ...
    imagem: "/assets/vaicorinthians.png",
  ...
  },
  {
    ...
    titulo: "Sputyfi",
    data: "19/02/2025",
    descricao: `Sputyfi é um projeto full-stack que desenvolvi como meu primeiro projeto utilizando React no front-end e um back-end próprio para gerenciar os dados. O objetivo é simular um player de música funcional, permitindo reproduzir áudio, navegar entre faixas e exibir informações sobre as músicas.<br><br>
    
    Este projeto foi desenvolvido com a ideia de praticar todas habilidades que eu aprendi até agora. Assim podendo caminhando para ser um Dev Full Stack.<br><br>
    
                  Front-end (React)<br><br>
  
                  •React Hooks: useState, useEffect.<br>
                  •Manipulação de Tempo: setInterval.<br>
                  •Manipulação de Áudio: useRef.<br>
                  •React Router: Navegação entre páginas.<br>
                  •CSS: Estilização responsiva para melhor experiência do usuário.<br>
                  •Vite: Configuração rápida do ambiente de desenvolvimento.<br>
                  •Type Modules: Organização modular do código.<br>
                  •Lógicas de map e filter para manipulação e exibição de dados dinâmicos.<br><br>
  
                  Back-end<br><br>
  
                  •Node.js & Express: Servidor para gerenciar as requisições.<br>
                  •Middleware CORS: Para permitir requisições entre diferentes domínios.<br>
                  •Banco de Dados: Utilizei MongoDB para fazer o meu banco de dados.<br>
                  •Instalação de Pacotes: Dependências gerenciadas via npm.
                  `,

    imagem: "/assets/sputyfi.png",
    videoSrc: "https://player.vimeo.com/video/1058342991?share=copy#t=0",
    repositorio: "https://github.com/thalesvarga/Sputyfi",
    site: "https://sputyfi.onrender.com/",
  },
];
